...
- **Editor / assistant**: Work was done from **Cursor**; that does not add files to the repo by itself.
...
2. **`README.md`**: Added this file to document environment setup, work done, and known Git issues.
